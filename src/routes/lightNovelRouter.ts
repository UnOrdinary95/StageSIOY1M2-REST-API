...
import { getLightNovels, getLightNovelById, deleteLightNovelById, createLightNovel, updateLightNovelById, uploadCoverById, getLightNovelsByGenre } from "../controllers/lightNovelController.js";
